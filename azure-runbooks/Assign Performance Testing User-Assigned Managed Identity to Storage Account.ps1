#name: Assign Performance Testing User-Assigned Managed Identity to Storage Account
#description: Assign Performance Testing user-assigned managed identity to a Storage Account to get a SAS Token.
