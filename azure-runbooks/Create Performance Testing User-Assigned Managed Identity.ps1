#name: Create Performance Testing User-Assigned Managed Identity
#description: Create a user-assigned managed identity to use in scripted actions for performance testing.
...
<# Variables:
{
  "UserManagedIdentityName": {
    ...
    "IsRequired": true,
    "DefaultValue": "uami-perfromancetesting-scripted-actions"
  },
  "ResourceGroupName": {
